      ...
      <div className="space-y-12">
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <p className="mt-1 text-sm leading-6 text-gray-600">
            If you know the exact part numbers required, please use parts search
            form, add the parts to the shopping cart and submit the inquiry.
            Alternatively, if you do not know the part numbers, please fill in
            the following form.
          </p>
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <ul className="list-disc ml-6">
            <li>
              <span className="text-[#C61D36]">
                Amayama Trading cannot supply windshields or side or rear
                windows. We apologise for any inconvenience.
              </span>
            </li>
            <li>
              <span className="text-[#C61D36]">
                Please also note that shock absorbers can be delivered by Fedex
                only.
              </span>
            </li>
          </ul>
